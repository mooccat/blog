			...
			<section v-for="abstract in articleList">
				<div class="abstract col-md-12 col-sm-12">
					<div class="abstract-img">
						<a href="">
							<img v-bind:src="abstract.img "alt="" style="width:100%;margin:10px 5px;"></a>
					</div>
					<div class="abstract-title">
						<h1>
							<a href="#" v-link="{path:'url'}">{{abstract.title}}</a>
						</h1>
					</div>
					...
					<div class="info-content">
						<div class="pull-left info-meta" >
							...
							<span class="posted-on"> <i class="glyphicon glyphicon-bookmark"></i>
								<a>
